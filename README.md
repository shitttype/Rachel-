...
.heart {
    ...
    filter: drop-shadow(0 0 20px rgba(255, 80, 60, 0.35));
}
...
<section class="page active" id="page1">
    <div class="content">
        ...
        <div class="subtitle">
            Una persona hace sonar un Love Alarm...<br>
            Y para mí, esa persona sos vos, Rachel.
        </div>

        <button class="next-button" onclick="nextPage(2)">
            →
        </button>
...
<section class="page yellow-page" id="page2">
    <div class="content">
        ...
        <button class="next-button" onclick="nextPage(3)">
            →
        </button>
